...
function DZStyle({children, isDragActive}) {
  return (
    ...
    <div className="flex justify-center w-full mx-auto sm:max-w-lg">
        ...
        <div className="flex flex-col items-center justify-center w-full h-auto my-20 bg-white sm:w-3/4 sm:rounded-lg sm:shadow-xl">
            ...
            <form  className="relative w-4/5 h-32 max-w-xs mb-1 bg-gray-100 rounded-lg shadow-inner">
                {children}
                <label for="file-upload" className="z-20 flex flex-col-reverse items-center justify-center w-full h-full cursor-pointer">
                    <p className="z-10 text-xs font-light text-center text-gray-500">{isDragActive ? <p>Drop the files here ...</p> : <p>Drag 'n' drop some files here, or click to select files</p>}</p>
